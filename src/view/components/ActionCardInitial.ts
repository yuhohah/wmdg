...
export class ActionCardInitial extends Container {
  ...
  constructor(props: ActionCardInitialProps) {
    ...
    this.buttonHelperText.position.set(this.cardWidth / 2, this.cardHeight - 26);
  ...
  private drawBackground(): void {
    ...
    this.dividerGraphics.lineTo(this.cardWidth - 20, this.cardHeight - 110);
