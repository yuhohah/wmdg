...
flowchart TD
    ...
    F -->|Árvore de Upgrades Fervor| G[7. Fórmulas DodecaDragons de Fervor]
    G -->|25 Fiéis| H[8. Converter Máximo Desbloqueado]
    G -->|20.000.000 Fé| I[9. Desbloqueio: Relíquias]
    I -->|Consagrar Fé: floor(log2(Fé+1))| J[10. Upgrades Mitológicos de Relíquias]
...
| **Fase 4: Consolidação do Avatar** | 800 Fé (Est. 2) e 15-20 Fiéis | 15 → 50 Fé/s (com buff 2x) | 1.0/s | 0 | **~1.5 a 2.5 min** | **~3.5 min** |
| **Fase 5: Ritos de Fervor** | Desbloqueio (5.000 Fé) | 50 → 150 Fé/s | 1.0 → 5.0/s | 0 | **~1.5 min** | **~5 min** |
| **Fase 6: Fervor DodecaDragons** | Upgrades Fervor + Sinergia Fiéis/Fé | 200 → 15.000+ Fé/s | 5.0 → 100+/s | 0 | **~5 a 10 min** | **~12 a 15 min** |
| **Fase 7: Rumo a 20M Fé** | Avatar Estágios 3 e 4 + FU1-FU5 | 20k → 500k+ Fé/s | 100 → 2.500/s | 0 | **~10 a 15 min** | **~25 a 30 min** |
| **Fase 8: Desbloqueio de Relíquias** | 20.000.000 Fé | 500k → 2M+ Fé/s | 2.500+/s | Inicia 1.0/s (rende 24 PR) | **~5 min** | **~30 a 35 min** |
| **Fase 9: Alquimia de Relíquias** | Cornucópia (200 PR) / Tocha (500 PR) | 2M → 50M+ Fé/s | 5.000 → 50.000/s | 1.0/s + Consagração | **~10 a 20 min** | **~45 min** |
| **Fase 10: Deep Late Game** | Avatar 5-7, Draupnir, Arca | 100M+ Fé/s | 100k+/s | 3.0 → 10.0+/s | **~30 a 60 min+** | **1h+** |
...
### ✅ Opção C (Implementada no Jogo — Estilo DodecaDragons Puro)
